...
CLASSES: dict[type, ClassDoc] = {
    ...
    fb.FBPlug: ClassDoc(
        functions=[
            ...
            FunctionDoc("GetSrcType", parameters=[ParamDoc("Index", int)]),
            FunctionDoc("GetDstType", parameters=[ParamDoc("Index", int)]),
            FunctionDoc("DisconnectDstAt", parameters=[ParamDoc("Index", int)]),
            FunctionDoc("DisconnectSrcAt", parameters=[ParamDoc("Index", int)]),
            FunctionDoc("ConnectSrc", parameters=[ParamDoc("Plug"), ParamDoc("ConnectionType")]),
            FunctionDoc("ConnectSrcAt", parameters=[ParamDoc("Index", int), ParamDoc("Plug"), ParamDoc("ConnectionType")]),
            FunctionDoc("ConnectDst", parameters=[ParamDoc("Plug"), ParamDoc("ConnectionType")]),
            FunctionDoc("ConnectDstAt", parameters=[ParamDoc("Index", int), ParamDoc("Plug"), ParamDoc("ConnectionType")]),
