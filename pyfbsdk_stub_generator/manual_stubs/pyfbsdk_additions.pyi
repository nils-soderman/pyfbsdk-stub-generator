...
def FBDestroyToolByName(name: str):
...
class FBBoxLayout(pyfbsdk.FBLayout):
    ...
    def _Resize(self, control: pyfbsdk.FBLayout, event: pyfbsdk.FBEventResize):
        ...

    def _GetDesc(self,control: pyfbsdk.FBVisualComponent) -> ControlDesc | None:
        ...

    def _Add(self, control: pyfbsdk.FBVisualComponent, size: int, ratio:float, customparams: __BoxLayoutCustomParams    ):
        ...
...
class FBGridLayout(pyfbsdk.FBLayout):
    ...
    def _Add(self, control:pyfbsdk.FBVisualComponent ,r1: int,r2: int,c1: int,c2: int,attachX: pyfbsdk.FBAttachType,attachY: pyfbsdk.FBAttachType,width:int|None,height:int|None):
        ...
